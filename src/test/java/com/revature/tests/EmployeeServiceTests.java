...
public class EmployeeServiceTests {
	...
	public void setup() {
		...
		eserv = new EmployeeService(mockdao); // we pass the mock dao into the service layer object so it uses our imposter object
	}
	...
	public void testConfirmLogin_success() {
		// should_returnSuccessful_When_correctUsernameAndPassword
	...
	public void testConfirmLogin_fail() {
		...
		// Test that when you pass in a username and password combo to the confirmLogin() method, it returns NULL
